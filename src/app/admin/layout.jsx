...
import {
  ...
  CreditCard, BookOpen, LogOut, Users, Target,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/tasks",    icon: Target,           label: "المهام اليومية" },
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link key={item.href} href={item.href}>
                <span className={`flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition-all ${
                  active
