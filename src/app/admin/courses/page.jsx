...
const SUBJECTS_BY_LEVEL = {
  ...
  "1sec_science":       ["لغة عربية","فرنسية","إنجليزية","رياضيات","تاريخ","جغرافيا","تربية إسلامية","فيزياء","علوم","إعلام آلي","تكنولوجيا"],
  "1sec_arts":          ["لغة عربية","فرنسية","إنجليزية","رياضيات","تاريخ","جغرافيا","تربية إسلامية","فيزياء","علوم","إعلام آلي"],

  "2sec_science_exp":   ["لغة عربية","فرنسية","إنجليزية","رياضيات","تاريخ","جغرافيا","تربية إسلامية","فيزياء","علوم طبيعية","إعلام آلي","فلسفة"],
  "2sec_science_math":  ["لغة عربية","فرنسية","إنجليزية","رياضيات","تاريخ","جغرافيا","تربية إسلامية","فيزياء","علوم طبيعية","إعلام آلي","فلسفة"],
  "2sec_science_tech":  ["لغة عربية","فرنسية","إنجليزية","رياضيات","تاريخ","جغرافيا","تربية إسلامية","فيزياء","إعلام آلي","فلسفة","هندسة كهربائية","هندسة ميكانيكية","هندسة مدنية","هندسة الطرائق"],
  "2sec_science_eco":   ["لغة عربية","فرنسية","إنجليزية","رياضيات","تاريخ","جغرافيا","تربية إسلامية","محاسبة","اقتصاد","قانون","إعلام آلي","فلسفة"],
  "2sec_arts_philo":    ["لغة عربية","فرنسية","إنجليزية","رياضيات","فلسفة","تاريخ","جغرافيا","تربية إسلامية","إعلام آلي","علوم طبيعية"],
  "2sec_arts_lang":     ["لغة عربية","فرنسية","إنجليزية","رياضيات","فلسفة","تاريخ","جغرافيا","تربية إسلامية","لغة ألمانية","لغة إسبانية","لغة إيطالية"],

  science_exp:          ["لغة عربية","إنجليزية","تربية إسلامية","تاريخ","رياضيات","فيزياء","علوم طبيعية"],
  science_math:         ["إنجليزية","تربية إسلامية","تاريخ","رياضيات","فيزياء","علوم طبيعية","إعلام آلي"],
  science_tech:         ["إنجليزية","تربية إسلامية","تاريخ","رياضيات","فيزياء","إعلام آلي","هندسة كهربائية","هندسة ميكانيكية","هندسة مدنية","هندسة الطرائق"],
  science_eco:          ["لغة عربية","محاسبة","اقتصاد","قانون","إنجليزية","تربية إسلامية","تاريخ","جغرافيا","رياضيات"],
  arts_philo:           ["لغة عربية","إنجليزية","فرنسية","تربية إسلامية","تاريخ","جغرافيا","فلسفة"],
  arts_lang:            ["لغة عربية","إنجليزية","فرنسية","تربية إسلامية","تاريخ","جغرافيا","لغة ألمانية","لغة إسبانية","لغة إيطالية"],
};
